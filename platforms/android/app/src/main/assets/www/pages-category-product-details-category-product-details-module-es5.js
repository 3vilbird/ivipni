...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-category-product-details-category-product-details-module"], {
  ...
  function srcAppPagesCategoryProductDetailsCategoryProductDetailsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function CategoryProductDetailsPage(navCtrl, productServices, users, toastCtrl, networkService, loadingCtrl, logger, holders, photoViewer, alertCtrl, route, router) {
        var _this2 = this;
      ...
      _createClass(CategoryProductDetailsPage, [{
        ...
        key: "imageview",
        value: function imageview(image, name) {
          this.photoViewer.show(image, name, {
            share: false
          });
        }
      }, {
