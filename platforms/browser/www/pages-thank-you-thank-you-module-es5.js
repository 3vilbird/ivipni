  ...
  function srcAppPagesThankYouThankYouPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      function ThankYouPage(router, route) {
        ...
        var _paymentDataObj; // var routeParams = JSON.parse(this.route.snapshot.queryParams.data);


        this.route.queryParams.subscribe(function (param) {
          _dataObj = JSON.parse(JSON.parse(param["data"]).data);
          _paymentDataObj = JSON.parse(param["data"]).pay; // console.log(_dataObj.order_id);
