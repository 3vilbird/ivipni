...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | pages-category-product-details-category-product-details-module */ "pages-category-product-details-category-product-details-module").then(__webpack_require__.bind(null, /*! ./pages/category-product-details/category-product-details.module */ "./src/app/pages/category-product-details/category-product-details.module.ts")).then((m) => m.CategoryProductDetailsPageModule),
    },
    {
        path: "category-product-details-info",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-category-product-details-info-category-product-details-info-module */ "pages-category-product-details-info-category-product-details-info-module").then(__webpack_require__.bind(null, /*! ./pages/category-product-details-info/category-product-details-info.module */ "./src/app/pages/category-product-details-info/category-product-details-info.module.ts")).then((m) => m.CategoryProductDetailsInfoPageModule),
    },
    {
        path: "chart",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-chart-chart-module */ "pages-chart-chart-module").then(__webpack_require__.bind(null, /*! ./pages/chart/chart.module */ "./src/app/pages/chart/chart.module.ts")).then((m) => m.ChartPageModule),
    },
    {
        path: "checkout",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-checkout-checkout-module */ "pages-checkout-checkout-module").then(__webpack_require__.bind(null, /*! ./pages/checkout/checkout.module */ "./src/app/pages/checkout/checkout.module.ts")).then((m) => m.CheckoutPageModule),
    },
    {
        path: "my-order",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-my-order-my-order-module */ "pages-my-order-my-order-module").then(__webpack_require__.bind(null, /*! ./pages/my-order/my-order.module */ "./src/app/pages/my-order/my-order.module.ts")).then((m) => m.MyOrderPageModule),
    },
    {
        path: "my-password",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-my-password-my-password-module */ "pages-my-password-my-password-module").then(__webpack_require__.bind(null, /*! ./pages/my-password/my-password.module */ "./src/app/pages/my-password/my-password.module.ts")).then((m) => m.MyPasswordPageModule),
    },
    {
        path: "my-profile",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-my-profile-my-profile-module */ "pages-my-profile-my-profile-module").then(__webpack_require__.bind(null, /*! ./pages/my-profile/my-profile.module */ "./src/app/pages/my-profile/my-profile.module.ts")).then((m) => m.MyProfilePageModule),
    },
    {
        path: "no-internet",
        loadChildren: () => Promise.all(/*! import() | pages-no-internet-no-internet-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-no-internet-no-internet-module")]).then(__webpack_require__.bind(null, /*! ./pages/no-internet/no-internet.module */ "./src/app/pages/no-internet/no-internet.module.ts")).then((m) => m.NoInternetPageModule),
    },
    {
        path: "notification",
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | pages-payment-details-payment-details-module */ "pages-payment-details-payment-details-module").then(__webpack_require__.bind(null, /*! ./pages/payment-details/payment-details.module */ "./src/app/pages/payment-details/payment-details.module.ts")).then((m) => m.PaymentDetailsPageModule),
    },
    {
        path: "paymentremain",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-paymentremain-paymentremain-module */ "pages-paymentremain-paymentremain-module").then(__webpack_require__.bind(null, /*! ./pages/paymentremain/paymentremain.module */ "./src/app/pages/paymentremain/paymentremain.module.ts")).then((m) => m.PaymentremainPageModule),
    },
    {
        path: "paymentremaindetails",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-paymentremaindetails-paymentremaindetails-module */ "pages-paymentremaindetails-paymentremaindetails-module").then(__webpack_require__.bind(null, /*! ./pages/paymentremaindetails/paymentremaindetails.module */ "./src/app/pages/paymentremaindetails/paymentremaindetails.module.ts")).then((m) => m.PaymentremaindetailsPageModule),
    },
    {
        path: "payment-success-failure",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-payment-success-failure-payment-success-failure-module */ "pages-payment-success-failure-payment-success-failure-module").then(__webpack_require__.bind(null, /*! ./pages/payment-success-failure/payment-success-failure.module */ "./src/app/pages/payment-success-failure/payment-success-failure.module.ts")).then((m) => m.PaymentSuccessFailurePageModule),
    },
    {
        path: "paythank-you",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-paythank-you-paythank-you-module */ "pages-paythank-you-paythank-you-module").then(__webpack_require__.bind(null, /*! ./pages/paythank-you/paythank-you.module */ "./src/app/pages/paythank-you/paythank-you.module.ts")).then((m) => m.PaythankYouPageModule),
    },
    {
        path: "place-order",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-place-order-place-order-module */ "pages-place-order-place-order-module").then(__webpack_require__.bind(null, /*! ./pages/place-order/place-order.module */ "./src/app/pages/place-order/place-order.module.ts")).then((m) => m.PlaceOrderPageModule),
    },
    {
        path: "privacy-policy",
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | pages-product-sub-category-product-sub-category-module */ "pages-product-sub-category-product-sub-category-module").then(__webpack_require__.bind(null, /*! ./pages/product-sub-category/product-sub-category.module */ "./src/app/pages/product-sub-category/product-sub-category.module.ts")).then((m) => m.ProductSubCategoryPageModule),
    },
    {
        path: "registration",
    ...
    {
        path: "reg-thankyou",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-reg-thankyou-reg-thankyou-module */ "pages-reg-thankyou-reg-thankyou-module").then(__webpack_require__.bind(null, /*! ./pages/reg-thankyou/reg-thankyou.module */ "./src/app/pages/reg-thankyou/reg-thankyou.module.ts")).then((m) => m.RegThankyouPageModule),
    },
    {
        path: "rootpage",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-rootpage-rootpage-module */ "pages-rootpage-rootpage-module").then(__webpack_require__.bind(null, /*! ./pages/rootpage/rootpage.module */ "./src/app/pages/rootpage/rootpage.module.ts")).then((m) => m.RootpagePageModule),
    },
    {
        path: "search-products",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-search-products-search-products-module */ "pages-search-products-search-products-module").then(__webpack_require__.bind(null, /*! ./pages/search-products/search-products.module */ "./src/app/pages/search-products/search-products.module.ts")).then((m) => m.SearchProductsPageModule),
    },
    {
        path: "seller-info",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-seller-info-seller-info-module */ "pages-seller-info-seller-info-module").then(__webpack_require__.bind(null, /*! ./pages/seller-info/seller-info.module */ "./src/app/pages/seller-info/seller-info.module.ts")).then((m) => m.SellerInfoPageModule),
    },
    {
        path: "seller-info-details",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-seller-info-details-seller-info-details-module */ "pages-seller-info-details-seller-info-details-module").then(__webpack_require__.bind(null, /*! ./pages/seller-info-details/seller-info-details.module */ "./src/app/pages/seller-info-details/seller-info-details.module.ts")).then((m) => m.SellerInfoDetailsPageModule),
    },
    {
        path: "shoppingcart",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-shoppingcart-shoppingcart-module */ "pages-shoppingcart-shoppingcart-module").then(__webpack_require__.bind(null, /*! ./pages/shoppingcart/shoppingcart.module */ "./src/app/pages/shoppingcart/shoppingcart.module.ts")).then((m) => m.ShoppingcartPageModule),
    },
    {
        path: "terms-of-use",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-terms-of-use-terms-of-use-module */ "pages-terms-of-use-terms-of-use-module").then(__webpack_require__.bind(null, /*! ./pages/terms-of-use/terms-of-use.module */ "./src/app/pages/terms-of-use/terms-of-use.module.ts")).then((m) => m.TermsOfUsePageModule),
    },
    {
        path: "thank-you",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-thank-you-thank-you-module */ "pages-thank-you-thank-you-module").then(__webpack_require__.bind(null, /*! ./pages/thank-you/thank-you.module */ "./src/app/pages/thank-you/thank-you.module.ts")).then((m) => m.ThankYouPageModule),
    },
    {
        path: "welcome",
    ...
    {
        path: "wish-list",
        loadChildren: () => __webpack_require__.e(/*! import() | pages-wish-list-wish-list-module */ "pages-wish-list-wish-list-module").then(__webpack_require__.bind(null, /*! ./pages/wish-list/wish-list.module */ "./src/app/pages/wish-list/wish-list.module.ts")).then((m) => m.WishListPageModule),
    },
];
...
/* harmony import */ var src_providers_commerce_products__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/providers/commerce/products */ "./src/providers/commerce/products.ts");
/* harmony import */ var src_providers_commerce_users__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/providers/commerce/users */ "./src/providers/commerce/users.ts");
/* harmony import */ var src_providers_configurator_configurator__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/providers/configurator/configurator */ "./src/providers/configurator/configurator.ts");
/* harmony import */ var src_providers_holders_holders__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/providers/holders/holders */ "./src/providers/holders/holders.ts");
/* harmony import */ var src_providers_logger_logger__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/providers/logger/logger */ "./src/providers/logger/logger.ts");
/* harmony import */ var src_providers_network_rest__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/providers/network/rest */ "./src/providers/network/rest.ts");
/* harmony import */ var src_providers_network_service_network_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/providers/network-service/network-service */ "./src/providers/network-service/network-service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            src_providers_commerce_products__WEBPACK_IMPORTED_MODULE_9__["Products"],
            src_providers_commerce_users__WEBPACK_IMPORTED_MODULE_10__["Users"],
            src_providers_configurator_configurator__WEBPACK_IMPORTED_MODULE_11__["Configurator"],
            src_providers_holders_holders__WEBPACK_IMPORTED_MODULE_12__["Holders"],
            src_providers_logger_logger__WEBPACK_IMPORTED_MODULE_13__["Logger"],
            src_providers_network_rest__WEBPACK_IMPORTED_MODULE_14__["Rest"],
            src_providers_network_service_network_service__WEBPACK_IMPORTED_MODULE_15__["NetworkService"],
...
/* harmony import */ var _network_rest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../network/rest */ "./src/providers/network/rest.ts");
/* harmony import */ var _logger_logger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../logger/logger */ "./src/providers/logger/logger.ts");
...
let Products = class Products {
    constructor(restService, logger) {
        this.restService = restService;
        this.logger = logger;
    }
    getPromotionalProducts(callbackFn) {
    ...
    getPrimaryCategories(callbackFn) {
        var _this = this;
    ...
    getBrandName(callbackFn) {
        var _this = this;
        this.restService.get("/getBrandName", (data) => {
    ...
    getBestSellerProducts(callbackFn) {
        var _this = this;
        this.restService.get("/getBestSellerProducts", (data) => {
    ...
    getProductTypeCate(callbackFn) {
        var _this = this;
        this.restService.get("/getProdutTypeCate", (data) => {
    ...
    getAddress(callbackFn) {
        var _this = this;
        this.restService.get("/getAddress", (data) => {
    ...
    getContactUsDetails(callbackFn) {
        var _this = this;
        this.restService.get("/getContact", (data) => {
    ...
    getCatProdDetails(category_id, page, callbackFn) {
        var _this = this;
        this.restService.get("/getCatProdDetails?&category_id=" + category_id + "&page=" + page, (data) => {
    ...
    getSearchBarDetails(callbackFn) {
        var _this = this;
        this.restService.get("/getSearchDetails", (data) => {
    ...
    getOrders(callbackFn) {
        var _this = this;
        this.restService.get("/getOrders", (data) => {
    ...
    getSellerDetails(callbackFn) {
        var _this = this;
        this.restService.get("/getSellerDetails", (data) => {
            _this.logger.info("invoking get myorder details");
            callbackFn(data);
        }, () => {
            callbackFn([]);
    ...
    getMyOrderDeliverDetails(callbackFn) {
        var _this = this;
        this.restService.get("/getOrderDelivery", (data) => {
    ...
    getUserDetails(callbackFn) {
        var _this = this;
        this.restService.get("/getUserDetails", (data) => {
    ...
    getNotification(callbackFn) {
        var _this = this;
        this.restService.get("/getNotification", (data) => {
    ...
    getCartTotalDetails(callbackFn) {
        var _this = this;
    ...
    getPayment(callbackFn) {
        var _this = this;
        this.restService.get("/getPayment", (data) => {
    ...
    //checkout pay page
    getCheckOutPay(callbackFn) {
        var _this = this;
        this.restService.get("/getCheckPay", (data) => {
...
Products.ctorParameters = () => [
    { type: _network_rest__WEBPACK_IMPORTED_MODULE_3__["Rest"] },
    { type: _logger_logger__WEBPACK_IMPORTED_MODULE_4__["Logger"] }
];
Products = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_network_rest__WEBPACK_IMPORTED_MODULE_3__["Rest"], _logger_logger__WEBPACK_IMPORTED_MODULE_4__["Logger"]])
], Products);
...
/* harmony import */ var _network_rest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../network/rest */ "./src/providers/network/rest.ts");
/* harmony import */ var _logger_logger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../logger/logger */ "./src/providers/logger/logger.ts");
/* harmony import */ var _holders_holders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../holders/holders */ "./src/providers/holders/holders.ts");
...
let Users = class Users {
    constructor(restService, logger, holders) {
        this.restService = restService;
        this.logger = logger;
        this.holders = holders;
    }
    validateUser(loginId, passwd, deviceToken, callbackFn) {
        var _this = this;
    ...
    //validating otp
    validateOTP(otpNumber, loginId, callbackFn) {
        var _this = this;
        ...
        this.restService.posts("/validateOTP", { loginId: loginId, otp: otpNumber }, function (data) {
    ...
    newPassword(newPassword, callbackFn) {
        var _this = this;
        _this.logger.debug("newpassword data " + JSON.stringify(newPassword));
        this.restService.posting("/newPassword", newPassword, function (data) {
            if (callbackFn) {
                if (data.status == "1") {
                    callbackFn(data.status, data.message);
                }
    ...
    resetPassword(passwd, callbckFn) {
        var _this = this;
        _this.logger.debug("Reset Password as : " + passwd);
        this.restService.post("/resetPassword", { passwd: passwd }, function (data) {
            if (callbckFn) {
                if (data.status == "1") {
    ...
    registerNewUser(registrationDetails, callbckFn) {
        var _this = this;
    ...
    //gmail
    emailandsms(customer1_id, callbckFn) {
        var _this = this;
        _this.restService.post("/emailandsms", { customer_id: customer1_id }, function (data) {
            callbckFn("1", "email");
    ...
    changePassword(passwordDetail, callbckFn) {
        var _this = this;
    ...
    contactUs(contactDetails, callbckFn) {
        var _this = this;
    ...
    setWishlist(productId, callbckFn) {
        var _this = this;
    ...
    //delete wishlist
    deleteWishlist(wishProduct, callbackFn) {
        var _this = this;
    ...
    addToCart(addProduct, callbackFn) {
        var _this = this;
    ...
    //deviceinfo
    deviceInfo(deviceInfo, callbackFn) {
        var _this = this;
        this.restService.post("/deviceInfo", deviceInfo, function (data) {
    ...
    orderToCart(addProduct, callbackFn) {
        var _this = this;
    ...
    //add to wishlist
    wishlistToCart(addProduct, callbackFn) {
        var _this = this;
    ...
    updateCart(addProduct, callbackFn) {
        var _this = this;
        _this.logger.debug("addToCart users.ts file check " + JSON.stringify(addProduct));
    ...
    //remove cart
    removeCart(cartItem, callbackFn) {
        var _this = this;
    ...
    updateAddress(updateAdrressObj, callbackFn) {
        var _this = this;
    ...
    //add address
    addAddress(updateAdrressObj, callbackFn) {
        var _this = this;
    ...
    //setNotification
    setNotification(notificationDetails, callbckFn) {
        var _this = this;
    ...
    moveToCart(allAddtoCart, callbackFn) {
        var _this = this;
    ...
    placeOrder(payDetailsObj, callbackFn) {
        var _this = this;
    ...
    CODplaceOrder(payDetailsObj, callbackFn) {
        var _this = this;
        _this.logger.debug("checking placeOrder" + JSON.stringify(payDetailsObj));
    ...
    SeventyfiveplaceOrder(payDetailsObj, callbackFn) {
        var _this = this;
        _this.logger.debug("checking placeOrder" + JSON.stringify(payDetailsObj));
    ...
    //deleteAddress
    deleteAddress(addressId, callbackFn) {
        var _this = this;
    ...
    //searchDetails post
    searchDetails(searchData, page, callbackFn) {
        var _this = this;
...
Users = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_network_rest__WEBPACK_IMPORTED_MODULE_3__["Rest"],
        _logger_logger__WEBPACK_IMPORTED_MODULE_4__["Logger"],
        _holders_holders__WEBPACK_IMPORTED_MODULE_5__["Holders"]])
], Users);
...
Configurator = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Holders", function() { return Holders; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm2015/ionic-angular.js");
...
/*
  ...
  for more info on providers and Angular 2 DI.
*/
let Holders = class Holders {
    constructor(alertCtrl, loadingCtrl, toastCtrl, network, logger) {
    ...
    showNetworkAlert() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            var _this = this;
            let networkAlert = yield _this.alertCtrl.create({
...
Holders = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var rxjs_add_operator_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/add/operator/map */ "./node_modules/rxjs-compat/_esm2015/add/operator/map.js");
/* harmony import */ var _configurator_configurator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../configurator/configurator */ "./src/providers/configurator/configurator.ts");
...
Logger = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_configurator_configurator__WEBPACK_IMPORTED_MODULE_3__["Configurator"]])
], Logger);
...
let NetworkService = class NetworkService {
    constructor(alertCtrl, logger, Network) {
        this.alertCtrl = alertCtrl;
        this.logger = logger;
        this.Network = Network;
...
/* harmony import */ var _configurator_configurator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../configurator/configurator */ "./src/providers/configurator/configurator.ts");
/* harmony import */ var _network_service_network_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../network-service/network-service */ "./src/providers/network-service/network-service.ts");
/* harmony import */ var _logger_logger__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../logger/logger */ "./src/providers/logger/logger.ts");
...
*/
let Rest = class Rest {
    constructor(http, configurator, networkService, loadingCtrl, logger) {
        this.http = http;
    ...
    post(url, data, successCallbackFn, errorcallbackFn) {
        var _this = this;
        ...
        if (_this.networkService.nullConnection()) {
            ...
            this.http
                .post(_this.configurator.restServerBaseUrl +
                _this.configurator.restServerControllerUrl +
                url, data)
                .subscribe((result) => _this.postHandleSuccess(result, successCallbackFn, url), (error) => _this.postHandleError(error, errorcallbackFn, url));
        }
    }
    posting(url, data, successCallbackFn, errorcallbackFn) {
        var _this = this;
    ...
    posts(url, data, successCallbackFn, errorcallbackFn) {
        var _this = this;
        _this.logger.debug("Calling " + _this.configurator.restServerBaseUrl + url);
        if (_this.tokenNeeded(url)) {
            data["user_id"] = _this.userId;
        ...
        if (_this.networkService.nullConnection()) {
            ...
            this.http
                ...
                _this.configurator.restServerControllerUrl +
                url, data)
                .subscribe((result) => _this.postsHandleSuccess(result, successCallbackFn), (error) => _this.postsHandleError(error, errorcallbackFn));
        }
    }
    get(url, successCallbackFn, errorcallbackFn) {
        ...
        if (_this.networkService.nullConnection()) {
            ...
            this.http
                .get(_this.configurator.restServerBaseUrl +
                authdetails +
                _this.configurator.restServerControllerUrl +
                url)
                .subscribe((result) => _this.handleSuccess(result, successCallbackFn, loading, url), (error) => _this.handleError(error, errorcallbackFn, loading, url));
        }
    }
    gets(url) {
        var _this = this;
        ...
        let fullUrl = _this.configurator.restServerBaseUrl +
            authdetails +
            _this.configurator.restServerControllerUrl +
            url;
        var obs = rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"].create(function (observer) {
            if (_this.networkService.nullConnection()) {
                ...
                _this.http.get(fullUrl).subscribe((result) => _this.handleSuccessObserver((result) => result.json(), observer, loading, url), (error) => _this.handleErrorObserver(error, observer, loading, url));
            }
        });
        return obs;
    }
    ...
    setAuthentication(userId, authToken) {
        this.userId = userId;
        this.authToken = authToken;
    }
    setAuthToken(userId, authToken) {
        this.userId = userId;
        this.authToken = authToken;
    }
};
...
Rest = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"],
        _configurator_configurator__WEBPACK_IMPORTED_MODULE_5__["Configurator"],
        _network_service_network_service__WEBPACK_IMPORTED_MODULE_6__["NetworkService"],
        _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingController"],
        _logger_logger__WEBPACK_IMPORTED_MODULE_7__["Logger"]])
], Rest);
...
module.exports = __webpack_require__(/*! /home/devil/volume/projects/freelancingwork/new_work/ivipni-1/src/main.ts */"./src/main.ts");
